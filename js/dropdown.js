$(document).ready(function () {
    ...
    var newsRollInt = setInterval(newsAutoRoll, 5000)

    $("#news-roll li").bind('mouseover', function () {
        clearInterval(newsRollInt)
    })

    $("#news-roll li").bind('mouseout', function () {
        newsRoll = setInterval(newsAutoRoll, 5000)
    })
